...
#import "PhotoUploadWebService.h"

@implementation PhotoUploadWebService

+(PhotoUploadWebService*)service
{
    static PhotoUploadWebService *photoUploadService=nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        photoUploadService=[[PhotoUploadWebService alloc] initWithService:UPLOAD_PHOTO_SERVICE];
    });

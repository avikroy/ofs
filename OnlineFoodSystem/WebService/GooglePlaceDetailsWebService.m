//
//  GooglePlaceDetailsWebService.m
//  OnlineFoodSystem
//
...
@implementation GooglePlaceDetailsWebService

+(GooglePlaceDetailsWebService*)service
{
    static GooglePlaceDetailsWebService *googlePlaceDetailService=nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        googlePlaceDetailService=[[GooglePlaceDetailsWebService alloc] init];
    });
...
-(void)callGooglePlaceDetailsWebServiceForPlaceID:(NSString*)strPlaceID WithCompletionHandler:(WebServiceCompletionHandler)handler
{
    ...
    NSString *strUrlToCall=[NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/details/json?reference=%@&key=AIzaSyArYWLsN9mnWnLFV4dJjI1B7Dn6Nkd9ZPU",strPlaceID];
    urlForService=[NSURL URLWithString:strUrlToCall];
